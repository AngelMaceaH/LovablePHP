...
?>
    <div class="container-fluid">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb my-0 ms-2">
                ...
                <li class="breadcrumb-item active"><span>ZLO0037P</span></li>
            </ol>
        </nav>
    </div>
    </header>
    <div id="body-div" class="body flex-grow-3">
        <div class="card mb-5" style="height: 400px;">
            ...
            <div class="card-header">
                <h1 class="fs-4 mb-1 mt-2 text-center">Envío de correos electronicos de confirmación de pagos</h1>
            </div>
            <div class="card-body ">
                <div class="container p-5">
                    <div class="row mt-5">
                        ...
                        <div class="col-8">
                            <input type="text" class="form-control fw-bold" id="numPedido"
                                placeholder="Ingrese el número de pedido" required>
                        ...
                        <div class="col-2 text-center">
                            <button type="button" class="btn btn-danger text-white fw-bold" style="width:100%;"
                                onclick="sendCupon()"><i class="fa-solid fa-paper-plane"></i> Envíar</button>
                        </div>
                    </div>
                </div>
            </div>
    ...
    function sendCupon() {
        ...
        if (value == "") {
            ...
            let url = "/API.LovablePHP/ZLO0037P/SEND/?numped=" + value + "&sendclie=" + valueCk;
            fetch(url)
                .then(() => {
                    Swal.fire({
                        icon: 'success',
