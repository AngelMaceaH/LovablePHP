  ...
  ?>
    ...
    window.addEventListener('DOMContentLoaded', (event) => {
        ...
        exportExcel.addEventListener('click', (event) => {
            ...
            var url = "/API.LovablePHP/ZLO0023P/Export/?anopro=" + valAno +
    ...
    function chargeTable(valAno, valAgrup) {
        ...
        gArray['lineZ1Desc1'] = [];
        gArray['lineZ2Desc1'] = [];
        var urlList = "/API.LovablePHP/ZLO0023P/List/?anopro=" + valAno + "&agrup=" + valAgrup;
    ...
    function chargeHistoricoInit(valAno, valAgrup) {
        var url = "/API.LovablePHP/ZLO0023P/ListHistorico/?anopro=" + valAno + "&agrup=" + valAgrup +
            "";
        fetch(url)
            .then(response => response.json())
            .then(data => {
