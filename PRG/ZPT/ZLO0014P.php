                        ...
                        <table id="myTableSeguimiento" class="table stripe table-hover " style="width:100%">
                            <thead>
                                <tr class="sticky-top bg-white" style="font-size: 14px;">
                                    ...
                                    <th class="responsive-font-example text-end text-black">Promedio Mensual 12 Meses
                                    </th>
                                    ...
                                    <th class="responsive-font-example text-end text-black">Meses Inventario 12 Meses
                                    </th>
    ...
    $(document).ready(function() {
        ...
        if (responseAgrupaciones.code == 200) {
            ...
            for (let i = 0; i < responseAgrupaciones.data.length; i++) {
                options += "<option value='" + responseAgrupaciones.data[i]['CODIGO'] + "'>" +
                    responseAgrupaciones.data[i]['DESCRI'] + "</option>";
            }
        ...
        var table = $('#myTableSeguimiento').DataTable({
            ...
            buttons: [{
                ...
                customize: function(xlsx) {
                    ...
                    $('c[r=A1] t', sheet).text(
                        'REPORTE DE ANALISIS DE MOVIMIENTO DE INVENTARIO ' + ($(
                    ...
                    $('row', sheet).each(function() {
                        ...
                        $('c[r^="F"], c[r^="H"], c[r^="S"], c[r^="T"]', row).attr(
                            's', textDarkblue);
