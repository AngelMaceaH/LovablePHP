    ...
    <script>
        ...
        window.addEventListener('DOMContentLoaded', (event) => {
            ...
            btnExport.addEventListener("click", async () => {
                ...
                const url = `/API.LovablePHP/ZLO0029P/Export/?anopro=${valAno}&cia=${valAgrup}&linea=${valLinea}`;
                console.log(url);
                ...
                try {
                    ...
                    a.href = fileUrl;
                    a.download = `MesesInventario_${cbbLinea.options[cbbLinea.selectedIndex].text}_${cbbAgrup.options[cbbAgrup.selectedIndex].text}.xlsx`;
        ...
        async function chargeTable() {
            ...
            for (let index = (valAno - 4); index <= valAno; index++) {
                ...
                cont++;
                const urlList = `/API.LovablePHP/ZLO0029P/List/?anopro=${index}&cia=${valAgrup}&linea=${valLinea}`;
                try {
            ...
            chart1 = Highcharts.chart('container', {
                ...
                title: {
                    text: 'Meses inventario 6 meses <br>' + cbbLinea.options[cbbLinea.selectedIndex].text + ' - ' + cbbAgrup
