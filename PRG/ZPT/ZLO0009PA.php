...
<body>
  <?php
      ...
      if ($_SESSION['cia']==1) {
        $cia=" AND LO2255.CODCIA IN(35,47,50,52,56,57,59,63,64,65,68,70,72,73,74,75,76,78,82,85,88,90)";
      }elseif ($_SESSION['cia']==2) {
        $cia=" AND LO2255.CODCIA IN(20,22,21,23,24)";
      }elseif ($_SESSION['cia']==3) {
       $cia=" AND LO2255.CODCIA IN(49,66,69,71,86,89)";
      }elseif ($_SESSION['cia']==4) {
       $cia=" AND LO2255.CODCIA IN(48,53,61,62,77)";
      }elseif ($_SESSION['cia']==5) {
       $cia=" AND LO2255.CODCIA IN(60,80,54)";
      }elseif ($_SESSION['cia']==6) {
       $cia=" AND LO2255.CODCIA IN(83,87)";
      }elseif ($_SESSION['cia']==7) {
       $cia=" AND LO2255.CODCIA IN(81,91)";
      }
    ?>
     <div class="container-fluid">
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb my-0 ms-2">
              ...
              <li class="breadcrumb-item active"><span>ZLO0009PA</span></li>
            </ol>
          </nav>
        </div>
      </header>
      <div id="body-div" class="body flex-grow-1">
        <div class="card mb-5">
          ...
          <div class="position-relative">
              <form id="formFiltros" action="../../assets/php/ZPT/ZLO0009P/filtrosLogicaA.php" method="POST">
                <div class="row mb-2">
