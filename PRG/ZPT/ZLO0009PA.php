...
<body> 
  <?php
      ...
      if ($_SESSION['cia']==1) {
        $cia=" AND LO2255.CODCIA IN(35,47,50,52,56,57,59,63,64,65,68,70,72,73,74,75,76,78,82,85,88)";
      }elseif ($_SESSION['cia']==2) {
        $cia=" AND LO2255.CODCIA IN(20,22,21,23,24)";
      }elseif ($_SESSION['cia']==3) {
       $cia=" AND LO2255.CODCIA IN(49,66,69,71,86)";
