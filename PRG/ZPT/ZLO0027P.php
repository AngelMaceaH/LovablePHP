...
<body>
    ...
    <div class="container-fluid">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb my-0 ms-2">
                ...
                <li class="breadcrumb-item active"><span>ZLO0027P</span></li>
            </ol>
        </nav>
    </div>
    </header>
    <div id="body-div" class="body flex-grow-1">
        <div class="card mb-5">
            <div class="card-header">
                <h1 class="fs-4 mb-1 mt-2 text-center">Histórico meses de inventario por tienda</h1>
            </div>
            <div class="card-body">
                <div>
                                ...
                                <div class="col-12">
                                    <div class="p-0">
                                        <figure class="highcharts-figure">
                                            <div id="container-2" class="highcharts-dark text-white Math.rounded">
                                            </div>
                                        </figure>
                                    </div>
                                </div>
                    ...
                    <div class="table-responsive container-fluid p-3" style="width:100%">
                        <button type="button" id="btnExport-2" class="btn btn-success text-light fs-6 text-center mb-3"
                            style="width:280px;">
                            <i class="fa-solid fa-file-excel me-1"></i><b>Enviar a Excel</b>
                        </button>
                        <table id="tableInventario-2" class="table stripe table-hover text-center "
                            ...
                            <thead>
                                ...
                                <tr>
                                    ...
                                    <th class=" border border-dark bg-secondary align-middle">
                                        <span id="lblano1-2" class="fs-5"></span>
                                    </th>
                                    <th class=" border border-dark bg-secondary align-middle">
                                        <span id="lblano2-2" class="fs-5"></span>
                                    </th>
                                    <th class=" border border-dark bg-secondary align-middle">
                                        <span id="lblano3-2" class="fs-5"></span>
                                    </th>
                                    <th class=" border border-dark bg-secondary align-middle">
                                        <span id="lblano4-2" class="fs-5"></span>
                                    </th>
                                    <th class=" border border-dark bg-secondary align-middle">
                                        <span id="lblano5-2" class="fs-5"></span>
                                    </th>
                                </tr>
                            </thead>
                            <tbody id="tableInventarioDetalle-2">
                                <tr id="tr1-2">
                                    <td>Enero</td>
                                </tr>
                                <tr id="tr2-2">
                                        ...
                                        <form>
                                            <div class="row">
                                                ...
                                                <div class="col-12 col-lg-6">
                                                    ...
                                                    <select class="form-select mt-1 fw-bold" id="cbbTienda">
                                                    </select>
                                                </div>
                                                <div class="col-0 col-lg-3">
    ...
    <script>
        ...
        window.addEventListener('DOMContentLoaded', (event) => {
            ...
            const cbbTienda = document.getElementById('cbbTienda');
            const cbbAgrup = document.getElementById('cbbAgrup');
            let urlTiendas = ' /API.LovablePHP/Users/FindTbyAgrup/?codusu=' + usuario + '&cia=' + cbbAgrup.value
            ...
            cbbTienda.innerHTML = tiendasOptions;
            ...
            cbbTienda.addEventListener('change', (event) => {
                chargeTable();
            });
            ...
            btnExport.addEventListener("click", async () => {
                ...
                let valAgrup = cbbTienda.value;
                const url = `/API.LovablePHP/ZLO0027P/Export/?anopro=${valAno}&cia=${valAgrup}`;
                ...
                try {
                    ...
                    a.href = fileUrl;
                    a.download = `MesesInventario_${cbbTienda.options[cbbTienda.selectedIndex].text}.xlsx`;
            ...
            const btnExport2 = document.getElementById('btnExport-2');
            btnExport2.addEventListener("click", async () => {
                let valAno = parseInt(cbbAno.value);
                let valAgrup = cbbAgrup.value;
                const url = `/API.LovablePHP/ZLO0027P/Export2/?anopro=${valAno}&cia=${valAgrup}`;
                ...
                try {
                    ...
                    a.href = fileUrl;
                    a.download = `MesesInventario_${cbbAgrup.options[cbbAgrup.selectedIndex].text}.xlsx`;
                    document.body.appendChild(a);
                    a.click();
                    document.body.removeChild(a);
                    window.URL.revokeObjectURL(fileUrl);
        ...
        async function chargeTable() {
            ...
            for (let index = (valAno - 4); index <= valAno; index++) {
                ...
                cont++;
                const urlList = `/API.LovablePHP/ZLO0027P/List/?anopro=${index}&cia=${valAgrup}`;
                try {
            ...
            chart1 = Highcharts.chart('container', {
                ...
                title: {
                    text: 'Meses inventario 6 meses <br>' + cbbTienda
                        .options[cbbTienda.selectedIndex].text,
                    align: 'center',
                    style: {
                ...
                xAxis: {
                    ...
                    labels: {
                        style: {
                            color: '#FFFFFF' // Color blanco para etiquetas del eje X
                        }
                    }
                },
                yAxis: {
        ...
        async function chargeTable2() {
            line2MIN06M1 = []; line2MIN06M2 = []; line2MIN06M3 = []; line2MIN06M4 = []; line2MIN06M5 = [];
            let valAno = parseInt(cbbAno.value);
            let valAgrup = cbbAgrup.value;
            let cont = 1;
            const responseData = [];
            const tbody = document.getElementById('tableInventarioDetalle-2');
            tbody.innerHTML = `<tr id="tr1-2" class="bg-light border border-dark"><td>Enero</td></tr><tr id="tr2-2" class="bg-light border border-dark"><td>Febrero</td></tr><tr id="tr3-2" class="bg-light border border-dark"><td>Marzo</td></tr><tr id="tr4-2" class="bg-light border border-dark"><td>Abril</td></tr><tr id="tr5-2" class="bg-light border border-dark"><td>Mayo</td></tr><tr id="tr6-2" class="bg-light border border-dark"><td>Junio</td></tr><tr id="tr7-2" class="bg-light border border-dark"><td>Julio</td></tr><tr id="tr8-2" class="bg-light border border-dark"><td>Agosto</td></tr><tr id="tr9-2" class="bg-light border border-dark"><td>Septiembre</td></tr><tr id="tr10-2" class="bg-light border border-dark"><td>Octubre</td></tr><tr id="tr11-2" class="bg-light border border-dark"><td>Noviembre</td></tr><tr id="tr12-2" class="bg-light border border-dark"><td>Diciembre</td></tr>`;
            for (let index = (valAno - 4); index <= valAno; index++) {
                document.getElementById(`lblano${cont}-2`).innerHTML = 'Año ' + index;
                cont++;
                const urlList = `/API.LovablePHP/ZLO0027P/List2/?anopro=${index}&cia=${valAgrup}`;
                try {
                    const response = await fetch(urlList);
                    const data = await response.json();
            ...
            responseData.forEach((data) => {
                cont = 1
                data.forEach((item) => {
                    const tdRow = document.getElementById(`tr${cont}-2`);
                    const td2 = document.createElement('td');
                    td2.classList.add('bgGoldSoft', 'border', 'border-dark');
                    td2.innerHTML = parseFloat(item.MIN06M) === 0 ? '‎' : parseFloat(item.MIN06M).toLocaleString('es-419', { minimumFractionDigits: 2, maximumFractionDigits: 2 });
                    tdRow.appendChild(td2);
                ...
                data.forEach((item) => {
                    switch (anoCont) {
                        case 1:
                            line2MIN06M1.push(parseFloat(item.MIN06M));
                            break;
                        case 2:
                            line2MIN06M2.push(parseFloat(item.MIN06M));
                            break;
                        case 3:
                            line2MIN06M3.push(parseFloat(item.MIN06M));
                            break;
                        case 4:
                            line2MIN06M4.push(parseFloat(item.MIN06M));
                            break;
                        case 5:
                            line2MIN06M5.push(parseFloat(item.MIN06M));
                            break;
                        default:
                            break;
                    }
