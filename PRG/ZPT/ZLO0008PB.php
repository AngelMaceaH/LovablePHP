                ...
                <div class="demo">
                    <ul class="tablist" role="tablist">
                        ...
                        <li id="tab2" class="tablist__tab text-center p-3" aria-controls="panel2" aria-selected="false"
                            role="tab" tabindex="0">
                            <?php if ($paisfiltro==="01") { echo "Docenas";}else{echo "Unidades";}  ?></li>
                    </ul>
                            ...
                            <table id="myTableInvMeses" class="table stripe table-hover " style="width:100%">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="responsive-font-example text-end">Prom. Vta 12M
                                            <?php echo  $lblDocenas; ?></th>
                                        <th class="responsive-font-example text-end">Prom. Vta 6M
                                            <?php echo  $lblDocenas; ?></th>
                            ...
                            <table id="myTableInvUnidades" class="table stripe table-hover " style="width:100%">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="responsive-font-example fw-bold text-end">
                                            <?php if ($paisfiltro==="01") { echo "Docenas";}else{echo "Unidades";}  ?>
                                            Compradas 12M</th>
                                        <th class="responsive-font-example fw-bold text-end">
                                            <?php if ($paisfiltro==="01") { echo "Docenas";}else{echo "Unidades";}  ?>
                                            Vendidas 12M</th>
