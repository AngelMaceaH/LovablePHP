     ...
     <div class="container-fluid">
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb my-0 ms-2">
              ...
              <li class="breadcrumb-item active"><span>ZLO0010P</span></li>
            </ol>
          </nav>
        </div>
      </header>
      <div id="body-div" class="body flex-grow-1">
        <div class="card mb-5">
            <div class="card-header">
              <h1 class="fs-4 mb-1 mt-2 text-center">Análisis de Inventario por clasificación de productos por fábrica</h1>
            </div>
          <div class="card-body">
          ...
          <div class="card border border-0">
              ...
              <div class="row">
                     <div class="col-12 mb-2">
                      <button type="button" id="exportExcel" class="btn btn-success text-light fs-6 text-center" style="width:20%;">
                        ...
                        <div class="row ">
                            <div class="col-12">
                              ...
                              <select id="selectGrafica" class="form-select fw-bold">
                                ...
                                <option value="G6">Promedio histórico de inventario Con 50% descuento</option>
                                <option value="G7">Promedio histórico de inventario Con 60% descuento</option>
                                <option value="G8">Promedio histórico de inventario Con 70% descuento</option>
                                <option value="G9">Promedio histórico de inventario Con &gt;70% descuento</option>
                                <option value="G10">Promedio histórico de inventario Segundas Nivel 1</option>
                                <option value="G11">Promedio histórico de inventario Segundas Nivel 2</option>
                              </select>
                            </div>
                          <div class="col-12">
                            <div class="mt-4">
      ...
      <script>
        ...
        let barGra1=[];
        let barGra2=[];
        let gArray = {'lineSinDesc1':[],'lineSinDesc2':[],'line10Desc1':[], 'line10Desc2':[], 'line20Desc1':[], 'line20Desc2':[], 'line30Desc1':[], 'line30Desc2':[], 'line40Desc1':[], 'line40Desc2':[], 'line50Desc1':[], 'line50Desc2':[], 'line60Desc1':[], 'line60Desc2':[], 'line70Desc1':[], 'line70Desc2':[], 'line80Desc1':[], 'line80Desc2':[], 'lineZ1Desc1':[], 'lineZ1Desc2':[], 'lineZ2Desc1':[], 'lineZ2Desc2':[]};
        let seriesData=[];
        let chart1=null;
        let chart2=null;
        window.addEventListener('DOMContentLoaded', (event) => {
          ...
          const exportExcel = document.getElementById('exportExcel');
            exportExcel.addEventListener('click', (event) => {
              ...
              var url="http://172.16.15.20/API.LovablePHP/ZLO0010P/Export/?anopro="+valAno+"&agrup="+valAgrup+"&cia="+cbbAgrup.options[cbbAgrup.selectedIndex].text;
              fetch(url)
                  ...
                  .then(blob => {
                      ...
                      a.href = tempUrl;
                      a.download =
                      'InventarioProductos-Fabrica.xlsx'; // Puedes personalizar el nombre del archivo
        ...
        function chargeTable2(valAno,valAgrup) {
          //AÑO 2
          gArray['lineSinDesc2']=[]; gArray['line10Desc2']=[]; gArray['line20Desc2']=[]; gArray['line30Desc2']=[]; gArray['line40Desc2']=[]; gArray['line50Desc2']=[]; gArray['line60Desc2']=[]; gArray['line70Desc2']=[]; gArray['line80Desc2']=[]; gArray['lineZ1Desc2']=[];  gArray['lineZ2Desc2']=[];
          var urlList="http://172.16.15.20/API.LovablePHP/ZLO0010P/List/?anopro="+valAno+"&agrup="+valAgrup;
