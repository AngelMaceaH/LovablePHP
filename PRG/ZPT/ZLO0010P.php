...
<span class="loader"></span>
      ...
      <div id="body-div" class="body flex-grow-1">
        <div class="card mb-5">
            <div class="card-header">
              <h1 class="fs-4 mb-1 mt-2 text-center">Inventario por Clasificación de Productos Fabrica</h1>
            </div>
          <div class="card-body">
      ...
      <script>
        $( document ).ready(function() {
          ...
          var anopro='<?php echo $anopro; ?>';
            var sidesc='';var por10='';var por20='';var por30='';var por40='';
          ...
          if (responseList.code==200) {
           for (let i = 0; i < responseList.data.length; i++) {
             sidesc=responseList.data[i]['SIDESC'];
             por10=responseList.data[i]['POR10'];
             por20=responseList.data[i]['POR20'];
             por30=responseList.data[i]['POR30'];
             por40=responseList.data[i]['POR40'];
             por50=responseList.data[i]['POR50'];
             por60=responseList.data[i]['POR60'];
             por70=responseList.data[i]['POR70'];
             por80=responseList.data[i]['POR80'];
             porz1=responseList.data[i]['PORZ1'];
             porz2=responseList.data[i]['PORZ2'];
             total=responseList.data[i]['PORTOT'];
            options+='<tr>';
  ...
  Highcharts.chart('container', {
    ...
    lang: {      
      ...
      exporting: {
        enabled: true,
    filename: 'Clasificacion-Producto Fabrica',
          buttons: {
              contextButton: {
    ...
    legend: {
      ...
      series: [
        {
          data:[parseInt(sidesc),parseInt(por10),parseInt(por20),parseInt(por30),parseInt(por40),parseInt(por50),
          parseInt(por60),parseInt(por70),parseInt(por80),parseInt(porz1),parseInt(porz2)],
          dataLabels: [{
            enabled: true,
            inside: true,
            style: {
