  ...
  ?>
    ...
    <div id="body-div" class="body flex-grow-1">
        <div class="card mb-5">
            <div class="card-header">
                <h1 class="fs-4 mb-1 mt-2 text-center">Análisis de Inventario por clasificación de productos por fábrica
                </h1>
            </div>
            <div class="card-body">
                    ...
                    <table id="tableInventario" class="table stripe table-hover text-center "
                        ...
                        <thead>
                            ...
                            <tr>
                                ...
                                <th colspan="2" class=" border border-dark bg-secondary align-middle">Inventario Precio
                                    Regular</th>
                                <th colspan="14" class=" border border-dark bg-secondary align-middle">Inventario Con
                                    Descuento</th>
    ...
    window.addEventListener('DOMContentLoaded', (event) => {
        ...
        setTimeout(() => {
            chart1 = Highcharts.chart('container', {
                ...
                xAxis: {
                    categories: ['Prendas Sin Dscto.', 'Prendas 20%', 'Prendas 30%',
                        'Prendas 40%', 'Prendas 50%', 'Prendas 60%', 'Prendas 70%',
                        'Prendas >70%', 'Segundas Nivel 1', 'Segundas Nivel 2'
                    ],
                    crosshair: true,
                    accessibility: {
    ...
    function chargeTable(valAno, valAgrup) {
        ...
        fetch(urlList)
            ...
            .then(data => {
                if (data.code == 200) {
                    let total = 0, totdes = 0, tot10 = 0, tot20 = 0, tot30 = 0, tot40 = 0, tot50 = 0, tot60 = 0, tot70 = 0, tot80 = 0, totz1 = 0, totz2 = 0;
    ...
    function chargeGrafica() {
        ...
        chart1.update({
            ...
            xAxis: {
                categories: ['Prendas Sin Dscto.', 'Prendas 20%', 'Prendas 30%', 'Prendas 40%', 'Prendas 50%',
                    'Prendas 60%', 'Prendas 70%', 'Prendas >70%', 'Segundas Nivel 1', 'Segundas Nivel 2'
                ],
                crosshair: true,
                accessibility: {
                    description: 'Countries'
