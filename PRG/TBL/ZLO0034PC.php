...
<body>
  ...
  function chargeTasks() {
    ...
    let urlTasks =
      `http://172.16.15.20/API.LovablePHP/ZLO0034P/GetTasks/?ano=${ano}&mes=${mes}&usuario=${usuario}&area=${area}&servi=${servi}&opc=${opcion}&descri=${user}`;
                ...
                <div class="col-12">
                  ...
                  <div class="input-group">
                    <input id="inputEncaEditA" maxlength="50" type="text" class="form-control rounded-start"
                      placeholder="Escribe el encabezado" oninput="this.value = this.value.toUpperCase();">
          ...
          <div class="container rounded shadow-lg p-4">
            <div id="createDiv">
              <div class="row">
                ...
                <div class="col-12">
                  <label for="imagenInput" class="fw-bold mb-2 ms-1">Imagen</label>
    ...
    <div class="modal-dialog modal-lg modal-dialog-scrollable">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <div class="container" style="height:1200px !important;">
            <div class="demo">
              ...
              <div id="panel1" class="tablist__panel p-3 border" aria-labelledby="tab1" aria-hidden="false"
                ...
                <div class="input-group mt-2 mb-4">
                  <input class="form-control fw-bold text-black" id="datepicker1" name="datepicker1">
              ...
              <div id="panel2" class="tablist__panel is-hidden p-3 border" aria-labelledby="tab2" aria-hidden="true" role="tabpanel">
                <div class="input-group mt-2 mb-4">
                  <input type="text" class="form-control fw-bold text-black" id="inputSearch"
                    onkeypress="validateInput(event)" placeholder="Escribe el número de caso">
                  <button class="btn btn-danger text-white fw-bold rounded-end" type="button" onclick="searchCase()"><i
