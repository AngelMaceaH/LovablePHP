...
<body>
    ...
    <script>
        ...
        var previousSearch = "";
        function initTable() {
            console.log("/API.LovablePHP/ZLO0013P/List2/?marca=" + marca + "&plan=" +
            ...
            var table = $('#myTablePlaneacion').DataTable({
                ...
                "processing": true,
                "ajax": {
                    "url": "/API.LovablePHP/ZLO0013P/List2/?marca=" + marca + "&plan=" +
                        plan + "&estado=" + estado + "&btnor=" + btnOrder + "&inventarios=" + inventarios +
                        "&clasificacion=" + clasificacion + "&orden=" + orden + "&filtro=" + filtro +
                        "&repro=" + repro + "&formato=" + formato + "&searchVal=" + searchBox + "",
                    "type": "POST",
                ...
                buttons: [{
                        ...
                        customize: function(xlsx) {
                            ...
                            var i;
                            var y;
                            var f1 = '<font><sz val="11" /><name val="Calibri" /><color rgb="FF0000" /></font>'; // color rojo en la fuente
                            var f2 = '<font><sz val="11" /><name val="Calibri" /><color rgb="007800" /></font>'; // color verde en la fuente
                            var f3 = '<font><sz val="11" /><name val="Calibri" /><color rgb="00BBCD" /></font>'; // color cyan de la fuente
                            var f4 = '<font><sz val="11" /><name val="Calibri" /><color rgb="7E5006" /></font>'; // color marrón de la fuente
                            var f5 = '<font><sz val="11" /><name val="Calibri" /><color rgb="00377D" /></font>'; // color azul oscuro de la fuente
                            var f6 = '<font><sz val="11" /><name val="Calibri" /><color rgb="0F8900" /></font>'; // color verde oscuro de la fuente
                            var f7 = '<font><sz val="11" /><name val="Calibri" /><color rgb="C1C100" /></font>'; // color amarillo de la fuente
                            var f8 = '<font><sz val="11" /><name val="Calibri" /><color rgb="FFB202" /></font>'; // color naranja de la fuente
                            var f9 = '<font><sz val="11" /><name val="Calibri" /><color rgb="9F6CFF" /></font>'; // color morada de la fuente
                            ...
                            var s4 = '<xf numFmtId="0" fontId="2" fillId="2" borderId="0" applyFont="1" applyFill="1" applyBorder="1" xfId="0" applyAlignment="1"><alignment horizontal="center" wrapText="1"/></xf>';
                            var s5 = '<xf  numFmtId="200" fontId="' + (lastFontIndex + 1) + '" fillId="0" borderId="0" applyFont="1" applyFill="1" applyBorder="1" xfId="0" applyAlignment="1"><alignment horizontal="right"/></xf>';
                            var s6 = '<xf  numFmtId="200" fontId="' + (lastFontIndex + 2) + '" fillId="0" borderId="0" applyFont="1" applyFill="1" applyBorder="1" xfId="0" applyAlignment="1"><alignment horizontal="right"/></xf>';
                            var s7 = '<xf  numFmtId="300" fontId="' + (lastFontIndex + 1) + '" fillId="0" borderId="0" applyFont="1" applyFill="1" applyBorder="1" xfId="0" applyAlignment="1"><alignment horizontal="right"/></xf>';
                            var s8 = '<xf  numFmtId="300" fontId="' + (lastFontIndex + 2) + '" fillId="0" borderId="0" applyFont="1" applyFill="1" applyBorder="1" xfId="0" applyAlignment="1"><alignment horizontal="right"/></xf>';
                            var s9 = '<xf numFmtId="0" fontId="' + (lastFontIndex + 3) + '" fillId="0" borderId="0" applyFont="1" applyFill="1" applyBorder="1" xfId="0" applyAlignment="1"><alignment horizontal="right"/></xf>';
                            var s10 = '<xf numFmtId="0" fontId="' + (lastFontIndex + 4) + '" fillId="0" borderId="0" applyFont="1" applyFill="1" applyBorder="1" xfId="0" applyAlignment="1"><alignment horizontal="right"/></xf>';
                            var s11 = '<xf numFmtId="0" fontId="' + (lastFontIndex + 5) + '" fillId="0" borderId="0" applyFont="1" applyFill="1" applyBorder="1" xfId="0" applyAlignment="1"><alignment horizontal="right"/></xf>';
                            var s12 = '<xf numFmtId="0" fontId="' + (lastFontIndex + 6) + '" fillId="0" borderId="0" applyFont="1" applyFill="1" applyBorder="1" xfId="0" applyAlignment="1"><alignment horizontal="right"/></xf>';
                            var s13 = '<xf numFmtId="0" fontId="' + (lastFontIndex + 7) + '" fillId="0" borderId="0" applyFont="1" applyFill="1" applyBorder="1" xfId="0" applyAlignment="1"><alignment horizontal="right"/></xf>';
                            var s14 = '<xf numFmtId="0" fontId="' + (lastFontIndex + 8) + '" fillId="0" borderId="0" applyFont="1" applyFill="1" applyBorder="1" xfId="0" applyAlignment="1"><alignment horizontal="right"/></xf>';
                            var s15 = '<xf numFmtId="0" fontId="' + (lastFontIndex + 9) + '" fillId="0" borderId="0" applyFont="1" applyFill="1" applyBorder="1" xfId="0" applyAlignment="1"><alignment horizontal="right"/></xf>';

                            //MISMAS FUENTES FONDO ROSA
                            var s16 = '<xf  numFmtId="200" fontId="' + (lastFontIndex + 1) + '" fillId="' + (lastFillIndex + 1) + '" borderId="0" applyFont="1" applyFill="1" applyBorder="1" xfId="0" applyAlignment="1"><alignment horizontal="right"/></xf>';
                            var s17 = '<xf  numFmtId="200" fontId="' + (lastFontIndex + 2) + '" fillId="' + (lastFillIndex + 1) + '" borderId="0" applyFont="1" applyFill="1" applyBorder="1" xfId="0" applyAlignment="1"><alignment horizontal="right"/></xf>';
                            var s18 = '<xf  numFmtId="300" fontId="' + (lastFontIndex + 1) + '" fillId="' + (lastFillIndex + 1) + '" borderId="0" applyFont="1" applyFill="1" applyBorder="1" xfId="0" applyAlignment="1"><alignment horizontal="right"/></xf>';
                            var s19 = '<xf  numFmtId="300" fontId="' + (lastFontIndex + 2) + '" fillId="' + (lastFillIndex + 1) + '" borderId="0" applyFont="1" applyFill="1" applyBorder="1" xfId="0" applyAlignment="1"><alignment horizontal="right"/></xf>';
                            var s20 = '<xf numFmtId="0" fontId="' + (lastFontIndex + 3) + '" fillId="' + (lastFillIndex + 1) + '" borderId="0" applyFont="1" applyFill="1" applyBorder="1" xfId="0" applyAlignment="1"><alignment horizontal="right"/></xf>';
                            var s21 = '<xf numFmtId="0" fontId="' + (lastFontIndex + 4) + '" fillId="' + (lastFillIndex + 1) + '" borderId="0" applyFont="1" applyFill="1" applyBorder="1" xfId="0" applyAlignment="1"><alignment horizontal="right"/></xf>';
                            var s22 = '<xf numFmtId="0" fontId="' + (lastFontIndex + 5) + '" fillId="' + (lastFillIndex + 1) + '" borderId="0" applyFont="1" applyFill="1" applyBorder="1" xfId="0" applyAlignment="1"><alignment horizontal="right"/></xf>';
                            var s23 = '<xf numFmtId="0" fontId="' + (lastFontIndex + 6) + '" fillId="' + (lastFillIndex + 1) + '" borderId="0" applyFont="1" applyFill="1" applyBorder="1" xfId="0" applyAlignment="1"><alignment horizontal="right"/></xf>';
                            var s24 = '<xf numFmtId="0" fontId="' + (lastFontIndex + 7) + '" fillId="' + (lastFillIndex + 1) + '" borderId="0" applyFont="1" applyFill="1" applyBorder="1" xfId="0" applyAlignment="1"><alignment horizontal="right"/></xf>';
                            var s25 = '<xf numFmtId="0" fontId="' + (lastFontIndex + 8) + '" fillId="' + (lastFillIndex + 1) + '" borderId="0" applyFont="1" applyFill="1" applyBorder="1" xfId="0" applyAlignment="1"><alignment horizontal="right"/></xf>';
                            var s26 = '<xf numFmtId="0" fontId="' + (lastFontIndex + 9) + '" fillId="' + (lastFillIndex + 1) + '" borderId="0" applyFont="1" applyFill="1" applyBorder="1" xfId="0" applyAlignment="1"><alignment horizontal="right"/></xf>';
                            //MISMAS FUENTES FONDO AMARILLO
                            var s29 = '<xf  numFmtId="200" fontId="' + (lastFontIndex + 1) + '" fillId="' + (lastFillIndex + 2) + '" borderId="0" applyFont="1" applyFill="1" applyBorder="1" xfId="0" applyAlignment="1"><alignment horizontal="right"/></xf>';
                            var s30 = '<xf  numFmtId="200" fontId="' + (lastFontIndex + 2) + '" fillId="' + (lastFillIndex + 2) + '" borderId="0" applyFont="1" applyFill="1" applyBorder="1" xfId="0" applyAlignment="1"><alignment horizontal="right"/></xf>';
                            var s31 = '<xf  numFmtId="300" fontId="' + (lastFontIndex + 1) + '" fillId="' + (lastFillIndex + 2) + '" borderId="0" applyFont="1" applyFill="1" applyBorder="1" xfId="0" applyAlignment="1"><alignment horizontal="right"/></xf>';
                            var s32 = '<xf  numFmtId="300" fontId="' + (lastFontIndex + 2) + '" fillId="' + (lastFillIndex + 2) + '" borderId="0" applyFont="1" applyFill="1" applyBorder="1" xfId="0" applyAlignment="1"><alignment horizontal="right"/></xf>';
                            var s33 = '<xf numFmtId="0" fontId="' + (lastFontIndex + 3) + '" fillId="' + (lastFillIndex + 2) + '" borderId="0" applyFont="1" applyFill="1" applyBorder="1" xfId="0" applyAlignment="1"><alignment horizontal="right"/></xf>';
                            var s34 = '<xf numFmtId="0" fontId="' + (lastFontIndex + 4) + '" fillId="' + (lastFillIndex + 2) + '" borderId="0" applyFont="1" applyFill="1" applyBorder="1" xfId="0" applyAlignment="1"><alignment horizontal="right"/></xf>';
                            var s35 = '<xf numFmtId="0" fontId="' + (lastFontIndex + 5) + '" fillId="' + (lastFillIndex + 2) + '" borderId="0" applyFont="1" applyFill="1" applyBorder="1" xfId="0" applyAlignment="1"><alignment horizontal="right"/></xf>';
                            var s36 = '<xf numFmtId="0" fontId="' + (lastFontIndex + 6) + '" fillId="' + (lastFillIndex + 2) + '" borderId="0" applyFont="1" applyFill="1" applyBorder="1" xfId="0" applyAlignment="1"><alignment horizontal="right"/></xf>';
                            var s37 = '<xf numFmtId="0" fontId="' + (lastFontIndex + 7) + '" fillId="' + (lastFillIndex + 2) + '" borderId="0" applyFont="1" applyFill="1" applyBorder="1" xfId="0" applyAlignment="1"><alignment horizontal="right"/></xf>';
                            var s38 = '<xf numFmtId="0" fontId="' + (lastFontIndex + 8) + '" fillId="' + (lastFillIndex + 2) + '" borderId="0" applyFont="1" applyFill="1" applyBorder="1" xfId="0" applyAlignment="1"><alignment horizontal="right"/></xf>';
                            var s39 = '<xf numFmtId="0" fontId="' + (lastFontIndex + 9) + '" fillId="' + (lastFillIndex + 2) + '" borderId="0" applyFont="1" applyFill="1" applyBorder="1" xfId="0" applyAlignment="1"><alignment horizontal="right"/></xf>';
                            ...
                            sSh.childNodes[0].childNodes[5].innerHTML += s1 + s2 + s3 + s4 + s5 +  s6 + s7 + s8 + s9 + s10 + s11 + s12 + s13 + s14 + s15;
                            //AGREGANDO FONDO ROSA
                            sSh.childNodes[0].childNodes[5].innerHTML += s16 + s17 + s18 + s19 + s20 +s21 + s22 + s23 + s24 + s25 + s26 + xfRosa;
                            //AGREGANDO FONDO AMARILLO
                            sSh.childNodes[0].childNodes[5].innerHTML += s29 + s30 + s31 + s32 + s33 +s34 + s35 + s36 + s37 + s38 + s39 + xfAmarillo;
        ...
        function openModalVentas(estilo, data) {
            ...
            var urlResumen = "/API.LovablePHP/ZLO0013P/ListResumen/?ano=" + anoActual + "&estilo=" +
                estilo + "";
        ...
        function chargeDetalles(numano, estilo) {
            ...
            var urldeta = "/API.LovablePHP/ZLO0013P/ListDeta/?marca=" + marca + "&plan=" +
                plan + "&estado=" + estado + "&btnor=" + btnOrder + "&inventarios=" + inventarios +
                "&clasificacion=" + clasificacion + "&orden=" + orden + "&filtro=" + filtro +
