 ...
 //VALIDACIONES JS
   ...
   switch ($_SESSION['filtro']) {
    case '1': //UNIDADES
      ...
      INNER JOIN LBPRDDAT/DETA16 ON DETA16.DETC90 = T1.CODCIA
      WHERE T1.ANOPRO=".$_SESSION['AnoFiltro']." AND T1.MESPRO=".$_SESSION['MesFiltro']." ".$_SESSION['CompFiltro']." AND DETA16.DETUSU ='".$_SESSION["CODUSU"]."' AND DETA16.DETPR1 = 'LO1512P'
      ORDER BY COD.CODSEC";
      ...
      INNER JOIN LBPRDDAT/DETA16 ON DETA16.DETC90 = T1.CODCIA
      WHERE 1=1 ".$_SESSION['CompFiltro']."  AND DETA16.DETUSU ='".$_SESSION["CODUSU"]."' AND DETA16.DETPR1 = 'LO1512P'    
      ORDER BY CODSEC";
      ...
      FROM (
          ...
          WHERE T6.DETUSU='".$_SESSION["CODUSU"]."' AND T6.DETPR1 = 'LO1512P' 
          ORDER BY T7.CODSEC
      ) AS TF 
      ...
      INNER JOIN LBPRDDAT/LO0686 AS T2 ON T2.CODCIA = T1.CODCIA
      INNER JOIN LBPRDDAT/LO0705 AS T3 ON T3.CODCIA = T1.CODCIA      
      ORDER BY T2.CODSEC)AS UNIANO ON UNIANO.ID=TRA.ID)AS T1  INNER JOIN LBPRDDAT/DETA16 ON DETA16.DETC90 = T1.CODCIA
       WHERE 1=1 ".$_SESSION['CompFiltro']." AND DETA16.DETUSU ='".$_SESSION["CODUSU"]."' AND DETA16.DETPR1 = 'LO1512P' ORDER BY CODSEC";
      ...
      case '2'://TRANSACCIONES
        ...
        INNER JOIN LBPRDDAT/DETA1699 AS T6 ON T6.DETC90=T1.CODCIA 
        INNER JOIN LBPRDDAT/LO0686 AS T7 ON T7.CODCIA=T1.CODCIA
        WHERE T6.DETUSU='".$_SESSION["CODUSU"]."' AND T6.DETPR1 = 'LO1512P' ORDER BY T7.CODSEC";
   ...
   if ($_SESSION['filtro']==3 || $_SESSION['filtro']==4) {
    ...
    T6.RELCO2 = T1.CODCIA WHERE T3.DETUSU='".$_SESSION["CODUSU"]."' AND T3.DETPR1 = 'LO1512P' ".$_SESSION['CompFiltro']." ORDER BY T2.CODSEC";
    ...
    WHERE T5.DETUSU='".$_SESSION["CODUSU"]."' AND T5.DETPR1 = 'LO1512P') AS T1 WHERE 1=1 ".$_SESSION['CompFiltro']." ORDER BY CODSEC";
    ...
    ON TRA.CODCIA = Total.CODCIA AND TRA.FECPRO = ".$_SESSION['FechaFiltro'].") AS T4 ON T4.CODCIA = T1.CODCIA
      INNER JOIN ( SELECT CODCIA, SUM(SUBTOT) SUBTOT FROM(
        ...
        WHERE NOT EXISTS (SELECT 1 FROM LBDESDAT/".$tablaMES." WHERE MESPRO= ".$_SESSION['MesFiltro']." AND ANOPRO=".$_SESSION['AnoFiltro']." )GROUP BY CODCIA)GROUP BY CODCIA ORDER BY CODCIA) AS T5 
      ON T5.CODCIA = T1.CODCIA INNER JOIN LBPRDDAT/RELAR4 AS T6 ON 
      T6.RELCO2 = T1.CODCIA WHERE T3.DETUSU='".$_SESSION["CODUSU"]."' AND T3.DETPR1 = 'LO1512P' ".$_SESSION['CompFiltro']." ORDER BY T2.CODSEC) AS T1
      INNER JOIN (
      ...
      ON T4.RELCO2=T1.CODCIA INNER JOIN LBPRDDAT/DETA1699 AS T5
      ON T5.DETC90=T1.CODCIA 
      WHERE T5.DETUSU='".$_SESSION["CODUSU"]."' AND T5.DETPR1 = 'LO1512P' ORDER BY T2.CODSEC) AS T2 ON T1.ID=T2.ID
      INNER JOIN (
        ...
        INNER JOIN LBPRDDAT/DETA1699 AS T6 ON T6.DETC90=T1.CODCIA 
        INNER JOIN LBPRDDAT/LO0686 AS T7 ON T7.CODCIA=T1.CODCIA
        WHERE T6.DETUSU='".$_SESSION["CODUSU"]."' AND T6.DETPR1 = 'LO1512P') AS T3 ON T3.ID = T1.ID) ORDER BY CODSEC ASC";
        $resultpromedios=odbc_exec($connIBM,$promedios); 
   }
