...
?>
                    ...
                    <div class="d-flex">
                        ...
                        <label class="form-check-label fs-6 fw-bold mt-2">Filtrar&nbsp;por:</label>
                            <select id="filterBy" class="form-select fw-bold ms-2">
                                ...
                                <option value="T">Tienda online</option>
    ...
    function chargeTab1(ano1, ano2, mes1, mes2) {
        ...
        var url = 'http://172.16.15.20/API.LovablePHP/ZLO0020P/ListPanel1/?fechaFiltro='+ano1+mes1+'01&usuario='+usuario+'&case='+dolar + '&vend=1&filtro='+filterBy.value+'';
                                                                ...
                                                                <table id="tablePanel1" class="table stripe table-hover mt-2" style="width:100%" >
                                                                    <thead>
                                                                        <tr>
                                                                            ...
                                                                            <th class="text-end" style="width:21.5%;">Venta ` + getCurrentMonth(mes1) + ' ' +
            ano1 +
            `</th>
        ...
        const table = $("#tablePanel1").DataTable({
            ...
            buttons: [
                ...
                $('c[r=A1] t', sheet).text('CONSULTA DE VENTAS RESUMIDAS POR PAÍS - MES VS MES ANTERIOR');
    ...
    function chargeTab2(ano1, ano2, mes1, mes2) {
        mes1=mes1.toString().padStart(2, '0');
        var filterBy = document.getElementById("filterBy");
        var url = 'http://172.16.15.20/API.LovablePHP/ZLO0020P/ListPanel2/?fechaFiltro='+ano1+mes1+'01&usuario='+usuario+'&case='+dolar + '&vend=1&filtro='+filterBy.value+'';
        var response = ajaxRequest(url);
    ...
    function chargeTab3(ano1, ano2) {
        var filterBy = document.getElementById("filterBy");
        var url = 'http://172.16.15.20/API.LovablePHP/ZLO0020P/ListPanel3/?fechaFiltro='+ano1+mes1+'01&usuario='+usuario+'&case='+dolar + '&vend=1&filtro='+filterBy.value+'';
        var response = ajaxRequest(url);
        var resultData = [];
        var chartLabels = [];
        var chartValues1 = [];
                                                                ...
                                                                <table id="tablePanel3" class="table stripe table-hover mt-2" style="width:100%" >
                                                                    <thead>
                                                                        ...
                                                                        <th class="d-none">ID</th>
                                                                            ...
                                                                            <th style="width:21%;"></th>
                                                                            <th class="text-end" style="width:21.5%;">Venta ` +'Año ' +
            ano1 +
            `</th>
                                                                            <th class="text-end" style="width:22.5%;">Venta ` +
            'Año ' + ano2 + `</th>
    ...
    function chargeTab4(ano1, ano2,mes1) {
        var filterBy = document.getElementById("filterBy");
        var url = 'http://172.16.15.20/API.LovablePHP/ZLO0020P/ListPanel4/?fechaFiltro='+ano1+mes1+'01&usuario='+usuario+'&case='+dolar + '&vend=1&filtro='+filterBy.value+'';
         var response = ajaxRequest(url);
        var resultData = [];
        var chartLabels = [];
        var chartValues1 = [];
