     ...
     <div class="container-fluid">
                    ...
                    <div class="table-responsive" style="width:100%">
                          ...
                          <thead>
                                ...
                                <tr>
                                  ...
                                  <th colspan="16"class=" border border-dark bg-secondary align-middle">Ventas Con Descuento</th>
      ...
      <script>
        ...
        window.addEventListener('DOMContentLoaded', (event) => {
          ...
          const exportExcel = document.getElementById('exportExcel');
            exportExcel.addEventListener('click', (event) => {
              ...
              var url="http://172.16.15.20/API.LovablePHP/ZLO0025P/Export/?anopro="+valAno+"&agrup="+valAgrup+"&cia="+cbbAgrup.options[cbbAgrup.selectedIndex].text;
              fetch(url)
                  ...
                  .then(blob => {
                      ...
                      a.href = tempUrl;
                      a.download =
                      'VentasProductos-Fabrica.xlsx'; // Puedes personalizar el nombre del archivo
        ...
        function chargeHistoricoInit(valAno,valAgrup) {
          var url="http://172.16.15.20/API.LovablePHP/ZLO0025P/ListHistorico/?anopro="+valAno+"&agrup="+valAgrup+"";
          fetch(url)
          .then(response => response.json())
          .then(data => {
            let seriesData = [];
