  ...
  ?>
    ...
    <div id="body-div" class="body flex-grow-1">
        <div class="card mb-5">
            <div class="card-header">
                <h1 class="fs-4 mb-1 mt-2 text-center">Análisis de ventas por clasificación de productos por fábrica
                </h1>
            </div>
            <div class="card-body">
    ...
    window.addEventListener('DOMContentLoaded', (event) => {
        ...
        exportExcel.addEventListener('click', (event) => {
            ...
            var url = "/API.LovablePHP/ZLO0025P/Export/?anopro=" + valAno +
    ...
    function chargeTable(valAno, valAgrup) {
        ...
        gArray['lineZ1Desc1'] = [];
        gArray['lineZ2Desc1'] = [];
        var urlList = "/API.LovablePHP/ZLO0025P/List/?anopro=" + valAno + "&agrup=" + valAgrup;
    ...
    function chargeHistoricoInit(valAno, valAgrup) {
        var url = "/API.LovablePHP/ZLO0025P/ListHistorico/?anopro=" + valAno + "&agrup=" + valAgrup +
            "";
        fetch(url)
            .then(response => response.json())
            .then(data => {
