...
?>
    <div class="container-fluid">
                    ...
                    <div class="demo">
                        <ul class="tablist" role="tablist">
                            <li id="tab1" class="tablist__tab text-center p-3  is-active" aria-controls="panel1"
                                aria-selected="true" role="tab" tabindex="0">Detalle por factura</li>
                            <li id="tab2" class="tablist__tab text-center p-3" aria-controls="panel2"
                                aria-selected="false" role="tab" tabindex="0">Resumen por días</li>
                        </ul>
                            ...
                            <div class="container-fluid">
                                <div class="row">
                                    <div class="col-md-9 col-lg-10 col-xl-10 col-xxl-11 col-8 ">
                                        <h2 class="fs-4 mb-1 mt-4 text-center">Detalle de ventas por <b>factura</b>.
                                        </h2>
                                    </div>
                                    <div class="col-1 ">
                                        <a class='btn btn-light mt-2'
                                            href="/<?php echo $_SESSION['DEV'] ?>LovablePHP/PRG/ZFA/ZLO0001P.php"><b>Regresar</b></a>
                                    </div>
                                </div>
                                    ...
                                    <div class="row mb-2">
                                        ...
                                        <div class="col-sm-12 col-lg-6 mb-2">
                                            <div class="input-group">
                                                <input class="me-2" type="checkbox" value="1" id="productosCk1"
                                                    name="productosCk1">
                                ...
                                <div class="table-responsive">
                                    <label class="m-4 fw-bold">**Presione doble clic sobre la factura para ver detalles
                                        de la factura**</label>
                            ...
                            <div class="container-fluid">
                                ...
                                <form id="formFiltros2" action="../../assets/php/ZFA/ZLO0001P/logic3.php" method="POST">
                                    <div class="row mb-2">
                                        ...
                                        <div class="col-sm-12 col-lg-6 mb-2">
                                            <div class="input-group">
                                                <input class="me-2" type="checkbox" value="1" id="productosCk2"
                                                    name="productosCk2">
        ...
        <?php include '../../assets/js/PRG/ZFA/ZLO0001P/ZLO0001PA.php'; ?>
</body>
