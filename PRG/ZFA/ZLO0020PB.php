...
<body>
    ...
    document.addEventListener("DOMContentLoaded", (event) => {
        ...
        //TAB3
        document.getElementById("tab3").innerHTML = 'ANUAL  (AÑO COMPLETO)';
        ...
        $('#setMesTab').on('change', function() {
            ...
            ano1Tab = parseInt($("#setYearTab").val());
            ano2Tab = parseInt($("#setYearTab").val())-1;
            if (mes2Tab == 0) {
                mes2Tab = 12;
                ano2Tab = ano1Tab - 1;
            }
        ...
        const table = $("#tablePanel3").DataTable({
            ...
            buttons: [{
                    ...
                    customize: function(xlsx) {
                        ...
                        var textgreen2 = lastXfIndex + 8;
                        $('c[r=A1] t', sheet).text(
                            'CONSULTA DE VENTAS RESUMIDAS POR PAÍS - ANUAL  (AÑO COMPLETO)');
                        $('row:eq(0) c', sheet).attr('s', greyBoldCentered);
                        $('row:eq(1) c', sheet).attr('s', 7);
                        for (let index = 2; index <= 50; index++) {
                            $('row:eq(' + index + ') c[r^="B"]', sheet).attr('s', 52);
