...
WHERE ANOPRO=".($ano2)." AND MESPRO BETWEEN ".$mesNum1." AND ".$mesNum2." AND CODCIA IN (35,47,50,52,56,57,59,63,64,65,68,70,72,73,74,75,76,78,82,85,88)) T1
...
FROM (SELECT CODCIA, MARCA, CANVEN, VALVEN FROM LBPRDDAT/lo2234
WHERE ANOPRO=".($ano2-1)." AND MESPRO BETWEEN ".$mesNum1." AND ".$mesNum2." AND CODCIA IN (35,47,50,52,56,57,59,63,64,65,68,70,72,73,74,75,76,78,82,85,88)) T1
INNER JOIN LBPRDDAT/DESARC T2 ON T1.MARCA=T2.DESCO1 AND T1.CODCIA=T2.DESCOD
