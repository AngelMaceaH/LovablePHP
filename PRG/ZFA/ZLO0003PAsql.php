...
(SELECT ANO1.MARCA,ANO1.DESDES,ANO1.CANANO1 CANANO1, ANO1.VALANO1 VALANO1,ANO2.VALANO1 VALANO2, ANO2.CANANO1 CANANO2 FROM(
            SELECT MARCA,DESDES,SUM(CANANO1) CANANO1,SUM(VALANO1) VALANO1 FROM(
            SELECT ANO1.MARCA MARCA,ANO1.DESDES,ANO1.CANTIDAD CANANO1,ANO1.VALOR VALANO1 FROM (SELECT CODCIA,MARCA,DESDES,FLOOR(((FLOOR(CANTIDAD)*12) +ROUND((CANTIDAD - FLOOR(CANTIDAD)) * 100))) CANTIDAD, VALOR FROM (SELECT CODCIA,MARCA, MAX(DESDES) as DESDES, SUM(CANVEN) CANTIDAD, SUM(VALVEN) VALOR FROM (SELECT CODCIA, MARCA, CANVEN, VALVEN FROM LBPRDDAT/lo2234 WHERE ANOPRO=".($ano2)." AND MESPRO BETWEEN ".$mesNum1." AND ".$mesNum2." AND CODCIA IN  (49,66,69,71,86)) T1 INNER JOIN LBPRDDAT/DESARC T2 ON T1.MARCA=T2.DESCO1 AND T2.DESCOD=1 GROUP BY CODCIA,MARCA))ANO1  ) GROUP BY MARCA,DESDES) AS ANO1
            INNER JOIN(SELECT MARCA,DESDES,SUM(CANANO1) CANANO1,SUM(VALANO1) VALANO1 FROM(
            SELECT ANO1.MARCA MARCA,ANO1.DESDES,ANO1.CANTIDAD CANANO1,ANO1.VALOR VALANO1 FROM (SELECT CODCIA,MARCA,DESDES,FLOOR(((FLOOR(CANTIDAD)*12) +ROUND((CANTIDAD - FLOOR(CANTIDAD)) * 100))) CANTIDAD, VALOR FROM (SELECT CODCIA,MARCA, MAX(DESDES) as DESDES, SUM(CANVEN) CANTIDAD, SUM(VALVEN) VALOR FROM (SELECT CODCIA, MARCA, CANVEN, VALVEN FROM LBPRDDAT/lo2234 WHERE ANOPRO=".($ano2-1)." AND MESPRO BETWEEN ".$mesNum1." AND ".$mesNum2." AND CODCIA IN  (49,66,69,71,86)) T1 INNER JOIN LBPRDDAT/DESARC T2 ON T1.MARCA=T2.DESCO1 AND T2.DESCOD=1 GROUP BY CODCIA,MARCA))ANO1  ) GROUP BY MARCA,DESDES) AS ANO2
...
(SELECT ANO1.MARCA,ANO1.DESDES,ANO1.CANANO1 CANANO1, ANO1.VALANO1 VALANO1,ANO2.VALANO1 VALANO2, ANO2.CANANO1 CANANO2 FROM(
            SELECT MARCA,DESDES,SUM(CANANO1) CANANO1,SUM(VALANO1) VALANO1 FROM(
            SELECT ANO1.MARCA MARCA,ANO1.DESDES,ANO1.CANTIDAD CANANO1,ANO1.VALOR VALANO1 FROM (SELECT CODCIA,MARCA,DESDES,FLOOR(((FLOOR(CANTIDAD)*12) +ROUND((CANTIDAD - FLOOR(CANTIDAD)) * 100))) CANTIDAD, VALOR FROM (SELECT CODCIA,MARCA, MAX(DESDES) as DESDES, SUM(CANVEN) CANTIDAD, SUM(VALVEN) VALOR FROM (SELECT CODCIA, MARCA, CANVEN, VALVEN FROM LBPRDDAT/lo2234 WHERE ANOPRO=".($ano2)." AND MESPRO BETWEEN ".$mesNum1." AND ".$mesNum2." AND CODCIA IN (81)) T1 INNER JOIN LBPRDDAT/DESARC T2 ON T1.MARCA=T2.DESCO1 AND T2.DESCOD=1 GROUP BY CODCIA,MARCA))ANO1  ) GROUP BY MARCA,DESDES) AS ANO1
            INNER JOIN(SELECT MARCA,DESDES,SUM(CANANO1) CANANO1,SUM(VALANO1) VALANO1 FROM(
            SELECT ANO1.MARCA MARCA,ANO1.DESDES,ANO1.CANTIDAD CANANO1,ANO1.VALOR VALANO1 FROM (SELECT CODCIA,MARCA,DESDES,FLOOR(((FLOOR(CANTIDAD)*12) +ROUND((CANTIDAD - FLOOR(CANTIDAD)) * 100))) CANTIDAD, VALOR FROM (SELECT CODCIA,MARCA, MAX(DESDES) as DESDES, SUM(CANVEN) CANTIDAD, SUM(VALVEN) VALOR FROM (SELECT CODCIA, MARCA, CANVEN, VALVEN FROM LBPRDDAT/lo2234 WHERE ANOPRO=".($ano2-1)." AND MESPRO BETWEEN ".$mesNum1." AND ".$mesNum2." AND CODCIA IN (81)) T1 INNER JOIN LBPRDDAT/DESARC T2 ON T1.MARCA=T2.DESCO1 AND T2.DESCOD=1 GROUP BY CODCIA,MARCA))ANO1  ) GROUP BY MARCA,DESDES) AS ANO2
