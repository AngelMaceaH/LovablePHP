        ...
        window.addEventListener('DOMContentLoaded', (event) => {
          ...
          const exportExcel = document.getElementById('exportExcel');
            exportExcel.addEventListener('click', (event) => {
              ...
              var url="http://172.16.15.20/API.LovablePHP/ZLO0026P/Export/?anopro="+valAno+"&agrup="+valAgrup+"&cia="+cbbAgrup.options[cbbAgrup.selectedIndex].text;
              fetch(url)
                  ...
                  .then(blob => {
                      ...
                      a.href = tempUrl;
                      a.download =
                      'VentasProductos-Tiendas.xlsx'; // Puedes personalizar el nombre del archivo
