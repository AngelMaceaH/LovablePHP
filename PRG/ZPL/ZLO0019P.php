...
<body>
        ...
        <nav aria-label="breadcrumb" style="width:100%" class="d-flex justify-content-between">
            <div style="width:30%">
                <ol class="breadcrumb my-0 ms-2 mt-3">
                    ...
                    <li class="breadcrumb-item active"><span>ZLO0019P</span></li>
                </ol>
            </div>
            <div style="width:70%" class="d-flex justify-content-between me-5">
                ...
                <div style="width:55%"  class="d-flex">
                    <label class="form-control border border-0">Mostrando tiendas:</label>
    ...
    <div id="body-div" class="body ">
        <div class="card m-0 p-0">
            ...
            <table  id="tableMetricas" class="table stripe table-hover" style="width:10000px !important;">
                            <thead class="sticky-top bg-white ">
                                <tr >
                                    <th class="text-center sticky-col" style="width:5%;" colspan="1"></th>
                                    <th class="text-center fs-3  border border-dark bg-secondary"   colspan="1">Enero</th>
                                    <th class="text-center fs-3  border border-dark text-danger"   colspan="1">Febrero</th>
                                    <th class="text-center fs-3  border border-dark bg-secondary"   colspan="1">Marzo</th>
                                    <th class="text-center fs-3  border border-dark text-danger"   colspan="1">Abril</th>
                                    <th class="text-center fs-3  border border-dark bg-secondary"   colspan="1">Mayo</th>
                                    <th class="text-center fs-3  border border-dark text-danger"    colspan="1">Junio</th>
                                    <th class="text-center fs-3  border border-dark bg-secondary"   colspan="1">Julio</th>
                                    <th class="text-center fs-3  border border-dark text-danger"   colspan="1">Agosto</th>
                                    <th class="text-center fs-3  border border-dark bg-secondary"   colspan="1">Septiembre</th>
                                    <th class="text-center fs-3  border border-dark text-danger"   colspan="1">Octubre</th>
                                    <th class="text-center fs-3  border border-dark bg-secondary"   colspan="1">Noviembre</th>
                                    <th class="text-center fs-3  border border-dark text-danger"   colspan="1">Diciembre</th>
    ...
    <script>
        ...
        $(document).ready(function() {
           ...
           header.append('<th></th>');
           for (let i = 1; i <=12;  i++) {
            header.append(`<th class="text-center border border-dark bg-light">E-Com. Diunsa SF SPS</th>`);} 
           ...
           var arrayRegistros=['NUEVOS CLIENTES REGISTRADOS AL PROGRAMA DE LEALTAD',
            ...
            tbody.append(`<tr class="border border-dark">
                            ...
                            <td colspan="13" class="bg-dark"></td>
                        </tr>`);
