    ...
    $(document).ready(function() {
        ...
        if (responseCias.code == 200) {
            ...
            for (let i = 0; i < data.length; i++) {
                tienda = {
                    CODCIA: data[i].CODCIA,
                    COMDES: data[i].COMDES,
                    ESTADO: data[i].GRUC02
                };
                        ...
                        Object.keys(datosRow1).forEach(mes => {
                            ciasSelected.forEach(codcia => {
                                ...
                                if (codcia == 0) {
                                    if (totalMes == 0) {
                                        rowtd +=
                                            '<td class="text-end fontM border ' + bgColorC +
                                            ' border-dark"> </td>';
                                    } else {
                                        rowtd +=
                                            '<td class="text-end fontM border ' + bgColorC +
                                    ...
                                    rowtd += '<td class="text-end fontM border ' + bgColorC +
                                        ' border-dark">' +
                        ...
                        Object.keys(datosRow10).forEach(mes => {
                            ciasSelected.forEach(codcia => {
                                ...
                                if (codcia == 0) {
                                    ...
                                    if (codcia == 81 && parseInt(datosRow10[mes][codcia]) !=
                                        0) {
                        ...
                        Object.keys(datosRow11).forEach(mes => {
                            ciasSelected.forEach(codcia => {
                                ...
                                if (codcia == 0) {
                                    ...
                                    if (codcia == 81 && parseInt(datosRow11[mes][codcia]) !=
                                        0) {
                        ...
                        Object.keys(datosRow12).forEach(mes => {
                            ciasSelected.forEach(codcia => {
                                ...
                                if (codcia == 0) {
                                    ...
                                    if (codcia == 81 && parseInt(datosRow12[mes][codcia]) !=
                                        0) {
        ...
        if (responsePTransacciones.code == 200) {
            ...
            data.forEach(dato => {
                ...
                //ROW4
                datosRow4[dato.MESPRO][dato.CODCIA] = (parseFloat(dato.TRAVIP) / parseFloat(dato
                    .TOTTRA)) * 100;
                //ROW5
                datosRow5[dato.MESPRO][dato.CODCIA] = (parseFloat(dato.TRANOR) / parseFloat(dato
                    .TOTTRA)) * 100;
            });
                            ...
                            ciasSelected.forEach(codcia => {
                                ...
                                if (codcia == 0) {
                                    ...
                                    if (tottransacciones[currentMes] != 0) {
                                        promedio = (porcelea[currentMes] / tottransacciones[
                                            currentMes]) * 100;
                                    }
                                    if (promedio == 0) {
                                        rowtd +=
                        ...
                        Object.keys(datosRow2).forEach(mes => {
                            ciasSelected.forEach(codcia => {
                                ...
                                if (codcia == 0) {
                                    var promedio = 0;
                                    if (tottransacciones[currentMes] != 0) {
                                        promedio = (porceact[currentMes] / tottransacciones[
                                            currentMes]) * 100;
                                    }
                                    if (promedio == 0) {
                                        rowtd +=
                        ...
                        Object.keys(datosRow3).forEach(mes => {
                            ciasSelected.forEach(codcia => {
                                ...
                                if (codcia == 0) {
                                    var promedio = 0;
                                    if (tottransacciones[currentMes] != 0) {
                                        promedio = (tottralea[currentMes] / tottransacciones[
                                            currentMes]) * 100;
                                    }
                                    if (promedio == 0) {
                                        rowtd +=
                        ...
                        Object.keys(datosRow4).forEach(mes => {
                            ciasSelected.forEach(codcia => {
                                ...
                                if (codcia == 0) {
                                    ...
                                    rowtd += '<td class="text-end fontM border border-dark ' +
                                        bgColorC + ' ">' +
                                        ((datosRow4[mes][codcia] != 0 && !isNaN(datosRow4[mes][
                                                codcia
                                            ])) ? datosRow4[mes][codcia]
                                            .toLocaleString('es-419', {
                                                minimumFractionDigits: 2,
                                                maximumFractionDigits: 2
                                            }) + '%' : '‎') + '</td>';
                        ...
                        Object.keys(datosRow5).forEach(mes => {
                            ciasSelected.forEach(codcia => {
                                ...
                                if (codcia == 0) {
                                    ...
                                    rowtd += '<td class="text-end fontM border border-dark ' +
                                        bgColorC + ' ">' +
                                        ((datosRow5[mes][codcia] != 0 && !isNaN(datosRow5[mes][
                                                codcia
                                            ])) ? datosRow5[mes][codcia]
                                            .toLocaleString('es-419', {
                                                minimumFractionDigits: 2,
                                                maximumFractionDigits: 2
                                            }) + '%' : '‎') + '</td>';
                            ...
                            ciasSelected.forEach(codcia => {
                                ...
                                if (codcia == 0) {
                                    ...
                                    if (prototclie[currentMes] != 0) {
                                        promedio = (proemailte[currentMes] / prototclie[
                                            currentMes]) * 100;
                                    }
                                    if (promedio == 0) {
                                        rowtd +=
                        ...
                        Object.keys(datosRow5).forEach(mes => {
                            ciasSelected.forEach(codcia => {
                                ...
                                if (codcia == 0) {
                                    var promedio = 0;
                                    if (prototclie[currentMes] != 0) {
                                        promedio = (protelefono[currentMes] / prototclie[
                                            currentMes]) * 100;
                                    }
                                    if (promedio == 0) {
                                        rowtd +=
                        ...
                        Object.keys(datosRow7).forEach(mes => {
                            ciasSelected.forEach(codcia => {
                                ...
                                if (codcia == 0) {
                                    var promedio = 0;
                                    if (prototclie[currentMes] != 0) {
                                        promedio = (proemail[currentMes] / prototclie[
                                            currentMes]) * 100;
                                    }
                                    if (promedio == 0) {
                                        rowtd +=
                        ...
                        Object.keys(datosRow1).forEach(mes => {
                            ciasSelected.forEach(codcia => {
                                ...
                                if (codcia == 0) {
                                    ...
                                    rowtd += '<td class="text-end fontM border border-dark ' +
                                        bgColorC + ' ">' +
                                        (datosRow1[mes][codcia] != 0 ? 'D.' + datosRow1[mes][
                                                codcia
                                            ]
                                            .toLocaleString('es-419', {
                                                minimumFractionDigits: 2,
                        ...
                        Object.keys(datosRow2).forEach(mes => {
                            ciasSelected.forEach(codcia => {
                                ...
                                if (codcia == 0) {
                                    ...
                                    rowtd += '<td class="text-end fontM border border-dark ' +
                                        bgColorC + ' ">' +
                                        (datosRow2[mes][codcia] != 0 ? 'D.' + datosRow2[mes][
                                                codcia
                                            ]
                                            .toLocaleString('es-419', {
                                                minimumFractionDigits: 2,
                        ...
                        Object.keys(datosRow3).forEach(mes => {
                            ciasSelected.forEach(codcia => {
                                ...
                                if (codcia == 0) {
                                    ...
                                    rowtd += '<td class="text-end fontM border border-dark ' +
                                        bgColorC + ' ">' +
                                        (datosRow3[mes][codcia] != 0 ? 'D.' + datosRow3[mes][
                                                codcia
                                            ]
                                            .toLocaleString('es-419', {
                                                minimumFractionDigits: 2,
                        ...
                        Object.keys(datosRow4).forEach(mes => {
                            ciasSelected.forEach(codcia => {
                                ...
                                if (codcia == 0) {
                                    ...
                                    rowtd += '<td class="text-end fontM border border-dark ' +
                                        bgColorC + ' ">' +
                                        (datosRow4[mes][codcia] != 0 ? 'D.' + datosRow4[mes][
                                                codcia
                                            ]
                                            .toLocaleString('es-419', {
                                                minimumFractionDigits: 2,
