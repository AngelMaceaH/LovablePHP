...
<body>
    ...
    $(document).ready(function() {
                        ...
                        Object.keys(datosRow7).forEach(mes => {
                            [1, 3, 4, 5, 6, 19].forEach(codpai => {
                                ...
                                if (datosRow7[mes][1] != 0) {
                                    totalRow = parseFloat(datosRow7[mes][1]) + parseFloat(
                                            datosRow7[mes][3]) + parseFloat(datosRow7[mes][4]) +
                                        parseFloat(datosRow7[mes][5]) + parseFloat(datosRow7[
                                            mes][6]) + parseFloat(datosRow7[mes][19]);
                                }
                            });
                        });
                        break;
                        ...
                        Object.keys(datosRow8).forEach(mes => {
                            [1, 3, 4, 5, 6, 19].forEach(codpai => {
                                ...
                                if (datosRow8[mes][1] != 0) {
                                    totalRow = parseFloat(datosRow8[mes][1]) + parseFloat(
                                            datosRow8[mes][3]) + parseFloat(datosRow8[mes][4]) +
                                        parseFloat(datosRow8[mes][5]) + parseFloat(datosRow8[
                                            mes][6]) + parseFloat(datosRow8[mes][19]);
                                }
                            });
                        });
                        break;
                        ...
                        Object.keys(datosRow9).forEach(mes => {
                            [1, 3, 4, 5, 6, 19].forEach(codpai => {
                                ...
                                if (datosRow9[mes][1] != 0) {
                                    totalRow = parseFloat(datosRow9[mes][1]) + parseFloat(
                                            datosRow9[mes][3]) + parseFloat(datosRow9[mes][4]) +
                                        parseFloat(datosRow9[mes][5]) + parseFloat(datosRow9[
                                            mes][6]) + parseFloat(datosRow9[mes][19]);
                                }
                            });
                        });
                        break;
                        ...
                        Object.keys(datosRow10).forEach(mes => {
                            [1, 3, 4, 5, 6, 19].forEach(codpai => {
                                ...
                                if (datosRow10[mes][1] != 0) {
                                    totalRow = parseFloat(datosRow10[mes][1]) + parseFloat(
                                            datosRow10[mes][3]) + parseFloat(datosRow10[mes][
                                        4]) + parseFloat(datosRow10[mes][5]) + parseFloat(
                                            datosRow10[mes][6]) + parseFloat(datosRow10[mes][
                                            19]);
                                }
                            });
                        });
                        ...
                        Object.keys(datosRow11).forEach(mes => {
                            [1, 3, 4, 5, 6, 19].forEach(codpai => {
                                ...
                                if (datosRow11[mes][1] != 0) {
                                    totalRow = parseFloat(datosRow11[mes][1]) + parseFloat(
                                            datosRow11[mes][3]) + parseFloat(datosRow11[mes][
                                        4]) + parseFloat(datosRow11[mes][5]) + parseFloat(
                                            datosRow11[mes][6]) + parseFloat(datosRow11[mes][
                                            19]);
                                }
                            });
                        });
                        ...
                        Object.keys(datosRow12).forEach(mes => {
                            [1, 3, 4, 5, 6, 19].forEach(codpai => {
                                ...
                                if (datosRow12[mes][1] != 0) {
                                    totalRow = parseFloat(datosRow12[mes][1]) + parseFloat(
                                            datosRow12[mes][3]) + parseFloat(datosRow12[mes][
                                        4]) + parseFloat(datosRow12[mes][5]) + parseFloat(
                                            datosRow12[mes][6]) + parseFloat(datosRow12[mes][
                                            19]);
                                }
                            });
                        });
        ...
        if (responseTiendas.code == 200) {
            ...
            tbody.append("<tr><td colspan='74'></td></tr>");
            var rowtd = "";
            var suma = parseInt(data[0]['COUNT']) + parseInt(data[1]['COUNT']) + parseInt(data[2]['COUNT']) +
                parseInt(data[3]['COUNT']) + parseInt(data[4]['COUNT']) + parseInt(data[5]['COUNT']);
