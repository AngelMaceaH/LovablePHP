    ...
    if (responseMarcas.code==200) {
      validator=false;
        ...
        for (let i = 0; i < responseMarcas.data.length; i++) {
                        //HONDURAS
                        ano1hon=(responseMarcas.data[i]['HONVALANO1']!=0)?(responseMarcas.data[i]['HONVALANO1']):0;ano2hon=(responseMarcas.data[i]['HONVALANO2']!=0)?(responseMarcas.data[i]['HONVALANO2']):0;
                        can1hon=(responseMarcas.data[i]['HONCANANO1']!=0)?(responseMarcas.data[i]['HONCANANO1']):0;can2hon=(responseMarcas.data[i]['HONCANANO2']!=0)?(responseMarcas.data[i]['HONCANANO2']):0;
                        varhon=ano1hon-ano2hon;crehon=(ano1hon!=0 && ano2hon!=0)? parseFloat(((ano1hon/ano2hon)-1)*100):0;
                        //GUATEMALA
                        ano1gua=(responseMarcas.data[i]['GUAVALANO1']!=0)?(responseMarcas.data[i]['GUAVALANO1']):0;ano2gua=(responseMarcas.data[i]['GUAVALANO2']!=0)?(responseMarcas.data[i]['GUAVALANO2']):0;
                        can1gua=(responseMarcas.data[i]['GUACANANO1']!=0)?(responseMarcas.data[i]['GUACANANO1']):0;can2gua=(responseMarcas.data[i]['GUACANANO2']!=0)?(responseMarcas.data[i]['GUACANANO2']):0;
                        vargua=ano1gua-ano2gua; cregua=(ano1gua!=0 && ano2gua!=0)? parseFloat(((ano1gua/ano2gua)-1)*100):0;
                        //EL SALVADOR
                        ano1sal=(responseMarcas.data[i]['SALVALANO1']!=0)?(responseMarcas.data[i]['SALVALANO1']):0; ano2sal=(responseMarcas.data[i]['SALVALANO2']!=0)?(responseMarcas.data[i]['SALVALANO2']):0;
                        can1sal=(responseMarcas.data[i]['SALCANANO1']!=0)?(responseMarcas.data[i]['SALCANANO1']):0;can2sal=(responseMarcas.data[i]['SALCANANO2']!=0)?(responseMarcas.data[i]['SALCANANO2']):0;
                        varsal=ano1sal-ano2sal;cresal=(ano1sal!=0 && ano2sal!=0)? parseFloat(((ano1sal/ano2sal)-1)*100):0;
                        //COSTA RICA
                        ano1cos=(responseMarcas.data[i]['COSVALANO1']!=0)?(responseMarcas.data[i]['COSVALANO1']):0; ano2cos=(responseMarcas.data[i]['COSVALANO2']!=0)?(responseMarcas.data[i]['COSVALANO2']):0;
                        can1cos=(responseMarcas.data[i]['COSCANANO1']!=0)?(responseMarcas.data[i]['COSCANANO1']):0;can2cos=(responseMarcas.data[i]['COSCANANO2']!=0)?(responseMarcas.data[i]['COSCANANO2']):0;
                        varcos=ano1cos-ano2cos;crecos=(ano1cos!=0 && ano2cos!=0)? parseFloat(((ano1cos/ano2cos)-1)*100):0;
                        //NICARAGUA
                        ano1nic=(responseMarcas.data[i]['NICVALANO1']!=0)?(responseMarcas.data[i]['NICVALANO1']):0; ano2nic=(responseMarcas.data[i]['NICVALANO2']!=0)?(responseMarcas.data[i]['NICVALANO2']):0;
                        can1nic=(responseMarcas.data[i]['NICCANANO1']!=0)?(responseMarcas.data[i]['NICCANANO1']):0;can2nic=(responseMarcas.data[i]['NICCANANO2']!=0)?(responseMarcas.data[i]['NICCANANO2']):0;
                        varnic=ano1nic-ano2nic;crenic=(ano1nic!=0 && ano2nic!=0)? parseFloat(((ano1nic/ano2nic)-1)*100):0;
                        //REP. DOMINICANA
                        ano1rep=(responseMarcas.data[i]['REPVALANO1']!=0)?(responseMarcas.data[i]['REPVALANO1']):0; ano2rep=(responseMarcas.data[i]['REPVALANO2']!=0)?(responseMarcas.data[i]['REPVALANO2']):0;
                        can1rep=(responseMarcas.data[i]['REPCANANO1']!=0)?(responseMarcas.data[i]['REPCANANO1']):0;can2rep=(responseMarcas.data[i]['REPCANANO2']!=0)?(responseMarcas.data[i]['REPCANANO2']):0;
                        varrep=ano1rep-ano2rep;crerep=(ano1rep!=0 && ano2rep!=0)? parseFloat(((ano1rep/ano2rep)-1)*100):0;
                        //TOTALES
                        ano1tot=parseFloat(ano1hon)+parseFloat(ano1gua)+parseFloat(ano1sal)+parseFloat(ano1cos)+parseFloat(ano1nic)+parseFloat(ano1rep);
                        ano2tot=parseFloat(ano2hon)+parseFloat(ano2gua)+parseFloat(ano2sal)+parseFloat(ano2cos)+parseFloat(ano2nic)+parseFloat(ano2rep);
                        can1tot=parseFloat(can1hon)+parseFloat(can1gua)+parseFloat(can1sal)+parseFloat(can1cos)+parseFloat(can1nic)+parseFloat(can1rep);
                        can2tot=parseFloat(can2hon)+parseFloat(can2gua)+parseFloat(can2sal)+parseFloat(can2cos)+parseFloat(can2nic)+parseFloat(can2rep);
                        vartot=parseFloat(ano1tot)-parseFloat(ano2tot);
                        cretot=(parseFloat(ano1tot)!=0 && parseFloat(ano2tot)!=0)? parseFloat(((parseFloat(ano1tot)/parseFloat(ano2tot))-1)*100):0;
