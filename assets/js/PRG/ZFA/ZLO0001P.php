        ...
        $( document ).ready(function() {
            ...
            if (responseComarc.code==200) { 
              for (let i = 0; i < responseComarc.data.length; i++) {
               $("#comppro").append(' <option value='+responseComarc.data[i]['COMCOD']+' selected>'+responseComarc.data[i]['COMDES']+'</option>');
              }
            }
            ...
            if (responseDiayMes.code==200 && responseAnual.code==200) { 
              for (let i = 0; i < responseDiayMes.data.length; i++) {
                ...
                var creciAnual=0;
                (responseAnual.data[i]['ANO2']!=0)? creciAnual=(((responseAnual.data[i]['ANO1']/responseAnual.data[i]['ANO2'])-1)*100):creciAnual=0;
                var creciPromedio=0, varPromedios=0;
                if (case1!=2) {  
                ...
                let vendias="";let venmes="";let venmes2="";let venmes3="";let tdAnual="";let tdCreciAnual="";
                  ...
                  if(parseFloat(responseAnual.data[i]['VARIA'])<=0){
                    tdAnual="<td class='text-end responsive-font-example d-none text-danger' id='tdanual3'><b>"+mon+responseAnual.data[i]['VARIA'].toLocaleString('es-419', {minimumFractionDigits: 2,maximumFractionDigits: 2})+"</b></td>";}else{
                      tdAnual="<td class='text-end responsive-font-example d-none text-success' id='tdanual3'><b>"+mon+responseAnual.data[i]['VARIA'].toLocaleString('es-419', {minimumFractionDigits: 2,maximumFractionDigits: 2})+"</b></td>";
                  }
                  if(parseFloat(creciAnual)<=0){
                    tdCreciAnual="<td class='text-end responsive-font-example d-none text-danger' id='tdanual4'><b>"+parseInt(creciAnual)+"%</b></td>";}else{
                      tdCreciAnual="<td class='text-end responsive-font-example d-none text-success' id='tdanual4'><b>"+parseInt(creciAnual)+"%</b></td>";
                  }
                $('#tr'+i+'').append("<td class='responsive-font-example d-none'><b>"+responseDiayMes.data[i]['CODSEC']+"</b></td>");
                $('#tr'+i+'').append("<td class='responsive-font-example d-none'><b>"+responseDiayMes.data[i]['ID']+"</b></td>");
                ...
                if (case1!=2) { 
                  let prodia="";let tdPromedios="";let tdCrecimiento="";
                  if(parseFloat(responsePromedios.data[i]['PRODIA'])==0){
                    prodia="<td class='text-end responsive-font-example d-none text-danger' id='tdpro1' ><b>"+mon+responsePromedios.data[i]['PRODIA'].toLocaleString('es-419', {minimumFractionDigits: 2,maximumFractionDigits: 2})+"</b></td>";}else{
                    prodia="<td class='text-end responsive-font-example d-none' id='tdpro1' ><b>"+mon+responsePromedios.data[i]['PRODIA'].toLocaleString('es-419', {minimumFractionDigits: 2,maximumFractionDigits: 2})+"</b></td>";
                  }
                  if(parseFloat(varPromedios)<=0){
                    tdPromedios="<td class='text-end responsive-font-example d-none text-danger' id='tdpro5' ><b>"+mon+parseFloat(varPromedios).toLocaleString('es-419', {minimumFractionDigits: 2,maximumFractionDigits: 2})+"</b></td>";}else{
                    tdPromedios="<td class='text-end responsive-font-example d-none text-success' id='tdpro5' ><b>"+mon+parseFloat(varPromedios).toLocaleString('es-419', {minimumFractionDigits: 2,maximumFractionDigits: 2})+"</b></td>";
                  }
                  if(parseFloat(creciPromedio)<0){
                    tdCrecimiento="<td class='text-end responsive-font-example d-none text-danger' id='tdpro6' ><b>"+parseInt(creciPromedio.toFixed())+"%</b></td>";}else if(parseFloat(creciPromedio)>0){
                    tdCrecimiento="<td class='text-end responsive-font-example d-none text-success' id='tdpro6' ><b>"+parseInt(creciPromedio.toFixed())+"%</b></td>";
                  }else{ tdCrecimiento="<td class='text-end responsive-font-example d-none' id='tdpro6' ><b>"+parseInt(creciPromedio.toFixed())+"%</b></td>";}
                  $('#tr'+i+'').append(prodia);
                  $('#tr'+i+'').append("<td class='text-end responsive-font-example d-none' id='tdpro2' ><b>"+mon+responsePromedios.data[i]['PROMES'].toLocaleString('es-419', {minimumFractionDigits: 2,maximumFractionDigits: 2})+"</b></td>");
                  $('#tr'+i+'').append("<td class='text-end responsive-font-example d-none' id='tdpro3' ><b>"+mon+responsePromedios.data[i]['PROANO'].toLocaleString('es-419', {minimumFractionDigits: 2,maximumFractionDigits: 2})+"</b></td>");
                  $('#tr'+i+'').append("<td class='text-end responsive-font-example d-none' id='tdpro4' ><b>"+mon+responsePromedios.data[i]['PROANO2'].toLocaleString('es-419', {minimumFractionDigits: 2,maximumFractionDigits: 2})+"</b></td>");
               ...
               '</font>';
                ...
                for (let index = 3; index <= 100; index++) {
                  ...
                  ?>
                    ...
                    if (parseFloat($('row:eq('+index+') c[r^="M"]', sheet).text())<0) {
