...
$(document).ready(function() {
    ...
    if (responseMarcas.code == 200) {
        ...
        for (let i = 0; i < responseMarcas.data.length; i++) {
            ...
            valorAno1 = [parseFloat(ano1hon), parseFloat(ano1gua), parseFloat(ano1sal), parseFloat(ano1cos),
                parseFloat(ano1nic), parseFloat(ano1rep)
            ];
            valorAno2 = [parseFloat(ano2hon), parseFloat(ano2gua), parseFloat(ano2sal), parseFloat(ano2cos),
                parseFloat(ano2nic), parseFloat(ano2rep)
            ];
