        ...
        buttons: [
            {
                ...
                customize: function (xlsx) {
                   ...
                   '</font>';
                    ...
                    $('c[r=A1] t', sheet).text( 'COMPARATIVO MESES DE INVENTARIO EN TIENDAS (MESES)' );
        ...
        buttons: [
            {
                ...
                customize: function (xlsx) {
                   ...
                   '</font>';
                    ...
                    $('c[r=A1] t', sheet).text( 'COMPARATIVO MESES DE INVENTARIO EN TIENDAS (UNIDADES)');
                    $('row:eq(0) c', sheet).attr( 's', greyBoldCentered );
                    $('row:eq(1) c', sheet).attr( 's', 7 );
