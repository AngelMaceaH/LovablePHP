...
if ($mesGraficas2==12) {
  $GraficasMes="SELECT CODCIA,NOMCIA,MES1,MES2,MES3 FROM(SELECT T1.CODCIA, T1.NOMCIA, T1.SUBTOT MES1, T2.SUBTOT MES2,T3.SUBTOT MES3 FROM (
    ...
    FROM LBPRDDAT/LO0849 WHERE FECPRO BETWEEN ".$anoGraficas2.$mesGraficas2."01 AND ".$anoGraficas2.$mesGraficas2.$diagrafica." GROUP BY CODCIA  UNION ALL SELECT codcia, 0 AS subtot
...
//GRAFICA ANUAL
  ...
  FROM lbprddat/LO0850  AS T1 LEFT JOIN LBPRDDAT/LO0686 AS T3 ON T1.CODCIA = T3.CODCIA     
...
FROM (SELECT CODCIA, SUM(total) AS SUBTOT 
      ...
      FROM LBPRDDAT/LO0849 WHERE FECPRO = ".$fechaGraficas."  UNION ALL 
      SELECT codcia, 0 AS total, NUMTRA FROM LBPRDDAT/LO0849 
      WHERE NOT EXISTS (SELECT 1 FROM LBDESDAT/LO0849 WHERE fecpro=".$fechaGraficas." 
      ))GROUP BY CODCIA) AS Total LEFT JOIN LBPRDDAT/LO0849 AS TRA 
...
INNER JOIN ( SELECT CODCIA, SUM(SUBTOT) SUBTOT FROM(
  ...
  WHERE MESPRO = ".$mesGraficas1."  AND ANOPRO =".$anoGraficas1."  UNION ALL SELECT codcia, 0 AS subtot FROM LBPRDDAT/LO0850 
  WHERE NOT EXISTS (SELECT 1 FROM LBDESDAT/LO0850 WHERE MESPRO= ".$mesGraficas1."  AND ANOPRO=".$anoGraficas1."  )GROUP BY CODCIA)GROUP BY CODCIA ORDER BY CODCIA) AS T5 
